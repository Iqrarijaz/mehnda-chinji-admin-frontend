        ...
        <Modal
            title={
                <div className="flex items-center gap-3 px-2">
                    ...
                    <div>
                        <span className="text-lg font-bold text-slate-900 block">Create Admin User</span>
                                ...
                                <>
                                    <div className="modal-section bg-slate-50/50 p-4 rounded-xl border border-slate-100 space-y-3">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                            ...
                                            <FormField label="Email Address" name="email" type="email" placeholder="john@example.com" required className="!h-[36px] !text-sm" />
                                            <FormField label="Phone Number" name="phone" placeholder="+1..." className="!h-[36px] !text-sm" />
                                            <div className="flex flex-col gap-1.5">
                                                <label className="text-slate-700 font-semibold text-xs text-xs">Security Password <span className="text-red-500">*</span></label>
