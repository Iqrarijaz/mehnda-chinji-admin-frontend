      ...
      <div className="flex flex-col items-center text-center p-4 w-full">
        ...
        {record?._id && (
          <div className="w-full bg-slate-50 rounded p-4 border border-slate-100 flex items-center gap-3 mb-8">
            <div className="w-10 h-10 rounded bg-white dark:bg-slate-800 flex items-center justify-center text-slate-400 dark:text-slate-500  transition-colors duration-300">
              <FaTerminal size={14} />
            </div>
