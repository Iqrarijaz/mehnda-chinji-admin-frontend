...
import { UPDATE_ANNOUNCEMENT } from "@/app/api/admin/announcements";
...
const UpdateAnnouncementModal = React.memo(({ modal, setModal }) => {
    ...
    const updateAnnouncement = useMutation({
        ...
        mutationFn: UPDATE_ANNOUNCEMENT,
        onSuccess: (data) => {
    ...
    const initialValues = React.useMemo(() => {
        if (!record) return { title: "", message: "", type: "public", essentialId: "", eventDate: null, files: [] };
        ...
        return {
            ...
            essentialId: record.essentialId?._id || record.essentialId || "",
            eventDate: record.eventDate ? moment(record.eventDate) : null,
            files: files
        };
    }, [record]);
    ...
    const handleSubmit = React.useCallback((values) => {
        ...
        formData.append("announcementId", record._id);
        ...
        <Modal
            title={
                <div className="flex items-center gap-2 px-0 py-1">
                    ...
                    <div>
                        <span className="text-lg font-bold text-[#006666] block mt-1">Edit Announcement</span>
                    </div>
                </div>
            }
            centered
...
UpdateAnnouncementModal.displayName = "UpdateAnnouncementModal";
