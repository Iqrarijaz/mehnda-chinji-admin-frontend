...
const UsersTable = React.memo(({ modal, setModal, usersList, onChange, setFilters, visibleColumns }) => {
    ...
    const allColumns = React.useMemo(() => [
        ...
        },
        {
            ...
            width: 150,
            sorter: true,
            render: (city) => <span className="font-semibold text-slate-600 dark:text-slate-400 text-[11px] whitespace-nowrap capitalize">{city || "N/A"}</span>,
        },
        {
            title: "Village",
            dataIndex: "village",
            ...
            width: 150,
            sorter: true,
            render: (village) => <span className="font-semibold text-slate-600 dark:text-slate-400 text-[11px] whitespace-nowrap capitalize">{village || "N/A"}</span>,
        },
        {
            title: "Created At",
            dataIndex: "createdAt",
        ...
        },
        {
            ...
            width: 120,
            sorter: true,
            render: (version) => <span className="font-semibold text-slate-600 dark:text-slate-400 text-[11px] whitespace-nowrap">{version || "N/A"}</span>,
        },
        {
            title: "",
            key: "actions",
