...
export default function ContactUsPage() {
    ...
    const statCards = [
        { label: "Pending", key: "PENDING", count: counts.PENDING, color: "#d97706", bg: "#fffbeb", border: "#fde68a" },
        { label: "Reviewed", key: "REVIEWED", count: counts.REVIEWED, color: "#7c3aed", bg: "#f5f3ff", border: "#ddd6fe" },
