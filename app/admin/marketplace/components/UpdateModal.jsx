...
const UpdateListingModal = React.memo(function UpdateListingModal({ modal, setModal }) {
    ...
    const handleUpdate = useMutation({
        ...
        mutationFn: (formData) => UPDATE_MARKETPLACE(formData),
        onSuccess: (data) => {
        ...
        onError: (error) => {
            toast.error(error.errorMessage || "Failed to update listing");
        }
    });
        ...
        >
            ...
            >
                ...
                <div className="flex justify-end gap-2 mt-6">
                    ...
                    <Button type="primary" htmlType="submit" loading={handleUpdate.isLoading}>
                        Update
                    </Button>
                </div>
            </Form>
