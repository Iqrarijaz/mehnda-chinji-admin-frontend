...
const CustomButton = ({
  ...
  const getVariantClasses = () => {
    switch (type) {
      case "primary":
        return "!bg-[#006666] !text-white border-none   hover:!bg-[#004d4d] transition-colors";
      case "secondary":
      ...
      case "danger":
        return "!bg-red-500 !text-white border-none   hover:!bg-red-600 transition-colors";
      default:
        return "";
    }
  };
  ...
  return (
    <Button
      ...
      disabled={disabled}
      className={cn(
        "!h-[40px] !px-4 !rounded-none text-xs transition-all flex items-center justify-center gap-2 font-medium shadow-none",
        getVariantClasses(),
        className
      )}
      {...props}
