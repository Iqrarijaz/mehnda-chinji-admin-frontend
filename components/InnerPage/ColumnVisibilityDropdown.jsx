...
function ColumnVisibilityDropdown({ options, columnOptions, visibleColumns, setVisibleColumns, className = "" }) {
    ...
    const visibilityMenu = (
        <Menu className="!rounded !p-2 shadow-xl border border-slate-100 min-w-[180px]">
            ...
            >
                {displayOptions.map((opt) => (
                    <Menu.Item key={opt.value} className="!bg-transparent !cursor-default hover:!bg-slate-50 !rounded">
